...
namespace tradingSoftware {
    ...
    public partial class TradeDataSet : global::System.Data.DataSet {
        ...
        public partial class AccountDataTable : global::System.Data.TypedTableBase<AccountRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public AccountRow AddAccountRow(string AccountName, string AccountPrintName, int AccountGroupID, string AddressLine1, string AddressLine2, string AddressLine3, string City, string State, string Pincode, string Email, string ContactPerson, int TelephoneNo, string PANNo) {
        ...
        public partial class TransactionDataTable : global::System.Data.TypedTableBase<TransactionRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public TransactionRow AddTransactionRow(System.DateTime Date, int ByAccountID, int ToAccountID, decimal Amount) {
        ...
        public partial class TransactionRow : global::System.Data.DataRow {
            ...
            public int ByAccountID {
                get {
                    return ((int)(this[this.tableTransaction.ByAccountIDColumn]));
                }
                set {
            ...
            public int ToAccountID {
                get {
                    return ((int)(this[this.tableTransaction.ToAccountIDColumn]));
                }
                set {
...
SELECT AccountID, AccountName, AccountPrintName, AccountGroupID, AddressLine1, AddressLine2, AddressLine3, City, State, Pincode, Email, ContactPerson, TelephoneNo, PANNo FROM Account WHERE (AccountID = SCOPE_IDENTITY())";
        ...
        public virtual int Delete(int Original_AccountID, string Original_AccountName, string Original_AccountPrintName, int Original_AccountGroupID, string Original_AddressLine1, string Original_AddressLine2, string Original_AddressLine3, string Original_City, string Original_State, string Original_Pincode, string Original_Email, string Original_ContactPerson, global::System.Nullable<int> Original_TelephoneNo, string Original_PANNo) {
            ...
            if ((Original_TelephoneNo.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[21].Value = ((int)(Original_TelephoneNo.Value));
            }
            else {
        ...
        public virtual int Insert(string AccountName, string AccountPrintName, int AccountGroupID, string AddressLine1, string AddressLine2, string AddressLine3, string City, string State, string Pincode, string Email, string ContactPerson, global::System.Nullable<int> TelephoneNo, string PANNo) {
            if ((AccountName == null)) {
            ...
            if ((TelephoneNo.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[11].Value = ((int)(TelephoneNo.Value));
            }
            else {
        ...
        public virtual int Update(
            ...
            if ((TelephoneNo.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[11].Value = ((int)(TelephoneNo.Value));
            }
            else {
            ...
            if ((Original_TelephoneNo.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[34].Value = ((int)(Original_TelephoneNo.Value));
            }
            else {
    ...
    public partial class TransactionTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Transaction] WHERE (([TransactionID] = @Original_TransactionID" +
                ") AND ([Date] = @Original_Date) AND ([ByAccountID] = @Original_ByAccountID) AND " +
                "([ToAccountID] = @Original_ToAccountID) AND ([Amount] = @Original_Amount))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Transaction] ([Date], [ByAccountID], [ToAccountID], [Amount]) " +
                "VALUES (@Date, @ByAccountID, @ToAccountID, @Amount);\r\nSELECT TransactionID, Date" +
                ", ByAccountID, ToAccountID, Amount FROM [Transaction] WHERE (TransactionID = SCO" +
                "PE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Transaction] SET [Date] = @Date, [ByAccountID] = @ByAccountID, [ToAccountID] = @ToAccountID, [Amount] = @Amount WHERE (([TransactionID] = @Original_TransactionID) AND ([Date] = @Original_Date) AND ([ByAccountID] = @Original_ByAccountID) AND ([ToAccountID] = @Original_ToAccountID) AND ([Amount] = @Original_Amount));
SELECT TransactionID, Date, ByAccountID, ToAccountID, Amount FROM [Transaction] WHERE (TransactionID = @TransactionID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_TransactionID, System.DateTime Original_Date, int Original_ByAccountID, int Original_ToAccountID, decimal Original_Amount) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(System.DateTime Date, int ByAccountID, int ToAccountID, decimal Amount) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime Date, int ByAccountID, int ToAccountID, decimal Amount, int Original_TransactionID, System.DateTime Original_Date, int Original_ByAccountID, int Original_ToAccountID, decimal Original_Amount, int TransactionID) {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_ByAccountID));
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Original_ToAccountID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime Date, int ByAccountID, int ToAccountID, decimal Amount, int Original_TransactionID, System.DateTime Original_Date, int Original_ByAccountID, int Original_ToAccountID, decimal Original_Amount) {
            return this.Update(Date, ByAccountID, ToAccountID, Amount, Original_TransactionID, Original_Date, Original_ByAccountID, Original_ToAccountID, Original_Amount, Original_TransactionID);
        }
    }
