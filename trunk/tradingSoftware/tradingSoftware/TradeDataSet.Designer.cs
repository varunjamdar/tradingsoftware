...
namespace tradingSoftware {
    ...
    public partial class TradeDataSet : global::System.Data.DataSet {
        ...
        public partial class CityDataTable : global::System.Data.TypedTableBase<CityRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public CityRow AddCityRow(string CityID, string StateID, string CityName) {
        ...
        public partial class StateDataTable : global::System.Data.TypedTableBase<StateRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public StateRow AddStateRow(string StateID, string StateName) {
...
namespace tradingSoftware.TradeDataSetTableAdapters {
    ...
    public partial class CityTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[City] ([CityID], [StateID], [CityName]) VALUES (@CityID, @Stat" +
                "eID, @CityName)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@StateID", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "StateID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string CityID, string StateID, string CityName) {
            if ((CityID == null)) {
            ...
            if ((StateID == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[1].Value = ((string)(StateID));
            }
            if ((CityName == null)) {
    ...
    public partial class StateTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[State] ([StateID], [StateName]) VALUES (@StateID, @StateName)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@StateID", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "StateID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string StateID, string StateName) {
            if ((StateID == null)) {
                throw new global::System.ArgumentNullException("StateID");
            }
            else {
